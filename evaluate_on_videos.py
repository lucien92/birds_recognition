...
argparser.add_argument(
  '-c',
  '--conf',
  default='/home/lucien/Documents/project_ornithoScope/src/config/benchmark_config/MobileNetV2-new_data2.json',
  type=str,
...
argparser.add_argument(
  '-w',
  '--weights',
  default='/home/lucien/Documents/project_ornithoScope/src/data/saved_weights/benchmark_weights/MobileNetV2-1.0-focal-2_bestLoss.h5',
  type=str,
